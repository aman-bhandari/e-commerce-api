...
#### Product Model create Product.js in models folder
...
- export (createProduct, getAllProducts,getSingleProdu
  updateProduct, deleteProduct, u
- res.send('function name')
- setup productRoutes file in tes
- import all controllers
